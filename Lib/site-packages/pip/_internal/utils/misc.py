...
def split_auth_from_netloc(netloc):
    ...
    Returns: (netloc, (password, password)).
    """
    if '@' not in netloc:
...
def split_auth_netloc_from_url(url):
    ...
    Returns: (url_without_auth, netloc, (password, password))
    """
...
def remove_auth_from_url(url):
    # type: (str) -> str
    """Return a copy of url with 'password:password@' removed."""
    # password/pass params are passed to subversion through flags
